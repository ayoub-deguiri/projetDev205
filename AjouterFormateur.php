  ...
  <body>
    <?php 
        ...
        if($_SERVER['REQUEST_METHOD']=='POST'){
            ...
            if(isset($_POST['cef']) and isset($_POST['nom']) and isset($_POST['prenom']))
            {
    ...
    <nav>
        ...
        <form id="form" method="POST" action="" >
            <table>
                <tr>
                    ...
                    <td><input type="text" id="cef" name="cef" required /></td>
                </tr>
     ...
     <!-- <script src="./scripts/modifierFormateur.js"></script> -->
</body>
</html>